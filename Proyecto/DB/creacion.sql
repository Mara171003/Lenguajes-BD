...
CREATE TABLE notaMes (
    ...
    CONSTRAINT fk_notaMes_usuario FOREIGN KEY (id_usuario) REFERENCES usuario(id_usuario)
);
...
CREATE TABLE administracion (
    ...
    pago VARCHAR2(20), --ejemplo: los 20 de cada mes
    monto DECIMAL(10, 2),
    id_usuario NUMBER,
    CONSTRAINT fk_administracion_usuario FOREIGN KEY (id_usuario) REFERENCES usuario(id_usuario)
);
