...
CREATE OR REPLACE PACKAGE pkg_rutina IS
    PROCEDURE sp_insert_rutina(
        p_nombre_rutina IN VARCHAR2,
        p_dia_rutina IN VARCHAR2,
        p_id_usuario IN NUMBER
    );

    PROCEDURE sp_update_rutina(
        p_id_rutina IN NUMBER,
        p_nombre_rutina IN VARCHAR2,
        p_dia_rutina IN VARCHAR2
    );

    PROCEDURE sp_delete_rutina(
        p_id_rutina IN NUMBER
    );

    PROCEDURE sp_get_rutinas(
        p_id_usuario IN NUMBER,
        p_cursor OUT SYS_REFCURSOR
    );

    PROCEDURE sp_get_rutina(
        p_id_rutina IN NUMBER,
        p_cursor OUT SYS_REFCURSOR
    );
END pkg_rutina;
...
CREATE OR REPLACE PACKAGE BODY pkg_rutina IS
    PROCEDURE sp_insert_rutina(
        p_nombre_rutina IN VARCHAR2,
        p_dia_rutina IN VARCHAR2,
        p_id_usuario IN NUMBER
...
CREATE OR REPLACE PACKAGE pkg_ejercicio IS
    PROCEDURE sp_insert_ejercicio(
        p_nombre_ejercicio IN VARCHAR2,
        p_setse IN VARCHAR2,
        p_maquina IN VARCHAR2,
        p_observaciones IN VARCHAR2,
    ...
    PROCEDURE sp_delete_ejercicio(
        p_id_ejercicio IN NUMBER
    );

    PROCEDURE sp_get_ejercicios(
        p_id_rutina IN NUMBER,
        p_cursor OUT SYS_REFCURSOR
    );

    PROCEDURE sp_get_ejercicio(
        p_id_ejercicio IN NUMBER,
        p_cursor OUT SYS_REFCURSOR
    );
END pkg_ejercicio;
...
CREATE OR REPLACE PACKAGE BODY pkg_ejercicio IS
    PROCEDURE sp_insert_ejercicio(
        p_nombre_ejercicio IN VARCHAR2,
        p_setse IN VARCHAR2,
        p_maquina IN VARCHAR2,
